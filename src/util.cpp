...
const char * const BITCOIN_CONF_FILENAME = "keymaker.conf";
const char * const BITCOIN_PID_FILENAME = "keymakerd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Keymaker";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Keymaker";
#else
    // Unix
    return pathRet / ".keymaker";
#endif
#endif
}
