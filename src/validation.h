...
static const bool DEFAULT_TXINDEX = true;  // keymaker: txindex is required for PoS calculations (might change in the future)
...
bool GetCoinAge(const CTransaction& tx, const CCoinsViewCache &view, const CBlockIndex* pindexPrev, uint64_t& nCoinAge, int nDepth = -1); // keymaker: get transaction coin age
