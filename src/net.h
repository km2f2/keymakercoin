...
static const int MAX_ADDNODE_CONNECTIONS = 48;
/** -listen default */
...
/** keymaker: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // keymaker: known sent sync-checkpoint
    ...
    // keymaker: used to detect branch switches
