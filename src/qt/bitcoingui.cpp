...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Keymaker address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and keymaker: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    unlockWalletAction->setStatusTip(tr("Unlock your wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Keymaker addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Keymaker addresses"));
    ...
    openAction->setStatusTip(tr("Open a keymaker: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Keymaker command-line options").arg(tr(PACKAGE_NAME)));

//    openChatroomAction = new QAction(QIcon(":/icons/keymaker"), tr("&Chatroom"), this);
//    openChatroomAction->setStatusTip(tr("Open the Keymaker Discord in a web browser."));

//    openForumAction = new QAction(QIcon(":/icons/keymaker"), tr("&Forum"), this);
//    openForumAction->setStatusTip(tr("Open https://explorer.keymakercoin.org/ in a web browser."));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Keymaker network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Keymaker"); // default title
