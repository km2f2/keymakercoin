...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s keymaker-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  keymaker-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded keymaker transaction") + "\n" +
              "  keymaker-tx [options] -create [commands]   " + _("Create hex-encoded keymaker transaction") + "\n" +
              "\n";
