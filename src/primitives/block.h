...
public:
    ...
    // keymaker: A copy from CBlockIndex.nFlags from other clients. We need this information because we are using headers-first syncronization.
    int32_t nFlags;
    // keymaker: Used in CheckProofOfStake().
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        // keymaker: do not serialize nFlags when computing hash
...
public:
    ...
    // keymaker: block signature - signed by coin base txout[0]'s owner
    ...
    // keymaker: two types of block: proof-of-work or proof-of-stake
    ...
    // keymaker: get max transaction timestamp
